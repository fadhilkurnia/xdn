...
variable "rc_ami" {
  ...
  type        = string
  default     = "ami-010dbcf82852375bc" # arm64, aws-geodemand: RECORDER init-sync (xdn-rc-arm64-20260606)
}
...
variable "ar_ami" {
  ...
  type        = string
  default     = "ami-00cb4e59815f18847" # arm64, aws-geodemand: RECORDER init-sync (xdn-ar-arm64-20260606)
}
