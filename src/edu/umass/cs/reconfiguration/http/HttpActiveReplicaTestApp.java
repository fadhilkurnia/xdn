...
/**
 * @author gaozy
 *     <p>A no-op example app for HttpActiveReplica
 */
public class HttpActiveReplicaTestApp extends AbstractReconfigurablePaxosApp<String>
  ...
  public boolean execute(Request request, boolean doNotReplyToClient) {
    ...
    if (request instanceof ReplicableClientRequest) return true;
    return processRequest((HttpActiveReplicaRequest) request, doNotReplyToClient);
  }

  private boolean processRequest(HttpActiveReplicaRequest request, boolean doNotReplyToClient) {
    if (request.getServiceName() == null) return true; // no-op
    if (request.isStop()) return true;
