...
/**
 * @author V. Arun
 *     <p>A reconfigurable request can also be a stop request and comes with an epoch number. The
 *     application must be aware of both of these if it uses any coordination protocol other than
 *     paxos.
 */
      ...
      public String toString() {
        return ReconfigurableRequest.this.getRequestType()
            ...
            + (ReconfigurableRequest.this instanceof RequestIdentifier
                ? ":" + ((RequestIdentifier) ReconfigurableRequest.this).getRequestID()
                : "")
