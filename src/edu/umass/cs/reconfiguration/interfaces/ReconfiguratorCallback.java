...
/**
 * @author V. Arun
 *     <p>The method executed(.) in this interface is called only by AbstractReplicaCoordinator that
 *     is an internal class. This interface is not (yet) expected to be implemented by a third-party
 *     class like an instance of Application.
 */
