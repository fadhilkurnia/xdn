...
/**
 * @author arun
 *     <p>This interface should be implemented by any gigapaxos client implementation.
 * @param <V>
 */
public interface GigaPaxosClient<V> {
  ...
  /**
   * This method will automatically convert {@code request} to {@link ClientRequest} via {@link
   * ReplicableClientRequest} if necessary.
   *
   * @param request
   * @param callback
   ...
   * @param request
   * @param callback
   * @return The long request identifier of the request if sent successfully; null otherwise.
   * @throws IOException
   */
  ...
  /**
   * Sends {@code request} to the nearest server as determined by {@code redirector}, an interface
   * that returns the nearest server from a set of server addresses.
   *
   * @param request
   * @param callback
   * @param redirector
