 ...
 * @param <NodeIDType>
 */
public interface ModifiableRCConfig<NodeIDType> extends ReconfigurableNodeConfig<NodeIDType> {

  /**
   * @param id
   * @param sockAddr
   * @return Socket address of previous mapping if any. FIXME: We really shouldn't be allowing
   *     remapping via an add method.
   */
