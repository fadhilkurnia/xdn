...
public interface ReplicaCoordinator<NodeIDType> {
   ...
   * @param request
   * @param callback
   * @return False if coordinated, else the result of local {@link Application#execute} invocation.
   * @throws IOException
  ...
  /**
   * This method should return true if the replica group is successfully created or one already
   * exists with the same set of nodes. It should return false otherwise.
   *
   * @param serviceName
   * @param epoch
   * @param state
  ...
  /**
   * This method must return the replica group that was most recently successfully created for the
   * serviceName using createReplicaGroup.
   *
   * @param serviceName
