...
/**
 * @author arun
 *     <p>A minimal interface defining reconfigurator server functions. This interface is
 *     implemented by {@link Reconfigurator} and must be implemented by any client or proxy for
 *     reconfigurators.
 */
public interface ReconfiguratorFunctions {
   ...
   * @param request
   * @param callback
   * @return A {@link RequestCallbackFuture} object that can be used by the caller to retrieve the
   *     processed response.
   */
  ...
  /**
   * @param request
   * @return The response to {@code request} that will have the same type as the request.
   */
