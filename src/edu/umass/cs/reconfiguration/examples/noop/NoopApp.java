 ...
 */
public class NoopApp implements Replicable, Reconfigurable, ClientMessenger {
  ...
  public boolean execute(Request request, boolean doNotReplyToClient) {
    ...
    switch ((AppRequest.PacketType) (request.getRequestType())) {
      case DEFAULT_APP_REQUEST:
        return processRequest((NoopAppRequest) request, doNotReplyToClient);
      default:
        break;
    }
    return false;
  ...
  private boolean processRequest(NoopAppRequest request, boolean doNotReplyToClient) {
    ...
    System.out.println("App-" + myID + " wrote " + data.name + " with state " + data.getState());
   ...
   * coordinator, as exemplified below in {@link #sendResponse(NoopAppRequest)} and supported by
   * gigapaxos.
   *
   * @param request
  ...
  public Request getRequest(String stringified) throws RequestParseException {
    ...
    try {
      ...
      ReconfigurationConfig.getLogger().info(myID + " unable to parse request " + stringified);
  ...
  public boolean restore(String name, String state) {
    ...
    if (data == null && state != null) {
      ...
      if (data != null)
        System.out.println("App-" + myID + " deleting " + name + " with state " + data.state);
