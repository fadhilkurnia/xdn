...
/**
 * @author V. Arun
 *     <p>A class like this is optional and is needed only if the application developer wants to use
 *     non-default means to instantiate an app replica. For most applications, the default
 *     reflection-based replica instantiation mechanism should suffice obviating this class.
 */
public class NoopReconfigurableNode extends ReconfigurableNode<String> {
   ...
   * @throws IOException
   */
  public NoopReconfigurableNode(String id, ReconfigurableNodeConfig<String> nc, boolean cleanSlate)
      throws IOException {
   ...
   * @throws IOException
   */
  public NoopReconfigurableNode(String id, ReconfigurableNodeConfig<String> nc) throws IOException {
    super(id, nc);
  }
  ...
  protected AbstractReplicaCoordinator<String> createAppCoordinator() {
    ...
    NoopAppCoordinator appCoordinator =
        new NoopAppCoordinator(
            app, NoopAppCoordinator.CoordType.PAXOS, this.nodeConfig, this.messenger);
  ...
  public static void main(String[] args) {
    ...
    ReconfigurableNodeConfig<String> nc =
        new DefaultNodeConfig<String>(
            PaxosConfig.getActives(), ReconfigurationConfig.getReconfigurators());
    try {
