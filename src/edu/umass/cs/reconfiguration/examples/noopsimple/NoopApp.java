...
/**
 * @author V. Arun
 *     <p>A simple no-op application example.
 */
public class NoopApp extends AbstractReconfigurablePaxosApp<String>
  ...
  public boolean execute(Request request, boolean doNotReplyToClient) {
    if (request.toString().equals(Request.NO_OP)) return true;
  ...
  private static AppRequest.PacketType[] mutualAuthTypes = {
