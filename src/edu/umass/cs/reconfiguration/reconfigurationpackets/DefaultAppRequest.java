...
/**
 * @author V. Arun
 *     <p>This request is unlike usual requests that can be converted to a String and back. This
 *     request is not meant to be serialized and sent over the network, but only passed internally
 *     within a single node.
 */
public class DefaultAppRequest implements ReplicableRequest, ReconfigurableRequest {
  protected enum Keys {
    STOP,
    SERVICE_NAME,
    EPOCH_NUMBER,
