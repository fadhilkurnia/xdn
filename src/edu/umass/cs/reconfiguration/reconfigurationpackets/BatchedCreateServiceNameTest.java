...
public class BatchedCreateServiceNameTest {
  ...
  public static void main(String[] args) {
    try {
      ...
      BatchedCreateServiceName bcreate1 = new BatchedCreateServiceName(isa, "random0", 0, "hello");
      BatchedCreateServiceName bcreate2 = new BatchedCreateServiceName(isa, names, 0, states);
