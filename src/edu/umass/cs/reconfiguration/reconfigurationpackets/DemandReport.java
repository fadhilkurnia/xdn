...
public class DemandReport<NodeIDType> extends BasicReconfigurationPacket<NodeIDType>
   ...
   */
  public DemandReport(
      NodeIDType initiator, String name, int epochNumber, AbstractDemandProfile demand) {
    super(initiator, ReconfigurationPacket.PacketType.DEMAND_REPORT, name, epochNumber);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      DemandReport<Integer> dr2 =
          new DemandReport<Integer>(dr.toJSONObject(), new StringifiableDefault<Integer>(0));
