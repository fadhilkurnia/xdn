...
public class AckStopEpoch<NodeIDType> extends BasicReconfigurationPacket<NodeIDType>
   ...
   * @param finalState
   */
  public AckStopEpoch(NodeIDType sender, StopEpoch<NodeIDType> stopEpoch, String finalState) {
    super(
        stopEpoch.getInitiator(),
  ...
  public AckStopEpoch(JSONObject json, Stringifiable<NodeIDType> unstringer) throws JSONException {
    ...
    this.finalState =
        json.has(Keys.FINAL_STATE.toString()) ? json.getString(Keys.FINAL_STATE.toString()) : null;
  }
