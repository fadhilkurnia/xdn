 ...
 * @param <NodeIDType>
 */
public abstract class BasicReconfigurationPacket<NodeIDType>
    extends ReconfigurationPacket<NodeIDType> implements Request {
   ...
   * @param epochNumber
   */
  public BasicReconfigurationPacket(
      NodeIDType initiator, PacketType t, String name, int epochNumber) {
    super(initiator);
    this.setType(t);
   ...
   */
  public BasicReconfigurationPacket(JSONObject json, Stringifiable<NodeIDType> unstringer)
      throws JSONException {
