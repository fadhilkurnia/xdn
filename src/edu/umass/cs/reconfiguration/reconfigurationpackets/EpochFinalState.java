...
public class EpochFinalState<NodeIDType> extends BasicReconfigurationPacket<NodeIDType> {
   ...
   * @param sender
   */
  public EpochFinalState(
      NodeIDType initiator, String name, int epochNumber, String state, NodeIDType sender) {
   ...
   */
  public EpochFinalState(JSONObject json, Stringifiable<NodeIDType> unstringer)
      throws JSONException {
    super(json, unstringer);
    this.state =
        (json.has(Keys.EPOCH_FINAL_STATE.toString())
            ? json.getString(Keys.EPOCH_FINAL_STATE.toString())
            : null);
  }
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      EpochFinalState<Integer> obj2 =
          new EpochFinalState<Integer>(obj1.toJSONObject(), new StringifiableDefault<Integer>(0));
