...
public class HelloRequest<NodeIDType> extends BasicReconfigurationPacket<NodeIDType>
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      HelloRequest<Integer> helloReq2 =
          new HelloRequest<Integer>(helloReq.toJSONObject(), new StringifiableDefault<Integer>(id));
      assert (helloReq2.toString().equals(helloReq.toString()));

      HelloRequest<Integer> helloReq3 =
          new HelloRequest<Integer>(
