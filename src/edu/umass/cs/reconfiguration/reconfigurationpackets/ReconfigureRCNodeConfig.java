...
public class ReconfigureRCNodeConfig<NodeIDType> extends ServerReconfigurationPacket<NodeIDType> {
   ...
   * @param sockAddr
   */
  public ReconfigureRCNodeConfig(
      NodeIDType initiator, NodeIDType nodeID, InetSocketAddress sockAddr) {
    super(initiator, ReconfigurationPacket.PacketType.RECONFIGURE_RC_NODE_CONFIG, nodeID, sockAddr);
  }
   ...
   */
  public ReconfigureRCNodeConfig(JSONObject json, Stringifiable<NodeIDType> unstringer)
      throws JSONException {
