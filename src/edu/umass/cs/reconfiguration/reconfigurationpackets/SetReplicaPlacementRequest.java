...
public class SetReplicaPlacementRequest extends ClientReconfigurationPacket {
  ...
  public SetReplicaPlacementRequest(
      InetSocketAddress initiator, String name, Set<String> placement) {
  ...
  public SetReplicaPlacementRequest(
      InetSocketAddress initiator, String name, Set<String> placement, String coordinatorNodeId) {
    super(initiator, PacketType.SET_REPLICA_PLACEMENT_REQUEST, name, 0);
    this.newReplicaPlacement = placement;
