...
public class CreateServiceNameTest {
  public static void main(String[] args) {
    try {
      ...
      for (int i = 0; i < names.length; i++) nameStates.put(names[i], states[i]);
          ...
          new CreateServiceName(
              ...
              new HashSet<InetSocketAddress>(
                  Arrays.asList(
                      ...
                      new InetSocketAddress(InetAddress.getLoopbackAddress(), 1235))));
      assert (c1.toString().equals(new CreateServiceName(c1.toJSONObject()).toString()))
