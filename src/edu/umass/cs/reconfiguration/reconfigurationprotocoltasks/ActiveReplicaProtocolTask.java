 ...
 * @author V. Arun
 */
public class ActiveReplicaProtocolTask<NodeIDType>
  ...
  private static final ReconfigurationPacket.PacketType[] types =
      ReconfigurationPacket.concatenate(defaultTypes, WaitEpochFinalState.types);

  static {
    ReconfigurationPacket.assertPacketTypeChecks(
        defaultTypes, ActiveReplica.class, HANDLER_METHOD_PREFIX);
  }
   ...
   * @param ar
   */
  public ActiveReplicaProtocolTask(
      NodeIDType id, Stringifiable<NodeIDType> unstringer, ActiveReplica<NodeIDType> ar) {
    this.myID = id;
  ...
  public Set<ReconfigurationPacket.PacketType> getEventTypes() {
    Set<ReconfigurationPacket.PacketType> types =
        new HashSet<ReconfigurationPacket.PacketType>(
            Arrays.asList(ActiveReplicaProtocolTask.types));
    return types;
  }

  /**
   * @return Default packet types handled, i.e., not counting temporary protocol tasks.
   */
   ...
   */
  @SuppressWarnings("unchecked")
  public BasicReconfigurationPacket<NodeIDType> getReconfigurationPacket(JSONObject json)
      throws JSONException {
    return (BasicReconfigurationPacket<NodeIDType>)
        ReconfigurationPacket.getReconfigurationPacket(json, this.unstringer);
  }
}
