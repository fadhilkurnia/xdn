 ...
 * @author V. Arun
 */
public class TrivialRepliconfigurable
    implements Repliconfigurable, AppRequestParserBytes, GigapaxosShutdownable {
  ...
  public String checkpoint(String name) {
    if (this.app instanceof Replicable) return ((Replicable) this.app).checkpoint(name);
    throw new RuntimeException("Can not get stop request for a non-replicable app");
  }

  @Override
  public boolean restore(String name, String state) {
    if (this.app instanceof Replicable) return ((Replicable) this.app).restore(name, state);
    throw new RuntimeException("Can not get stop request for a non-replicable app");
  }
