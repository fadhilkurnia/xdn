...
/**
 * @param <NodeIDType> This class is the main Reconfigurator module. It issues
...
public class Reconfigurator<NodeIDType> implements
    ...
    /**
     * Sets the validator in {@link Reconfigurator#initialStateValidator} variable given the
     * class name. If unsuccessful (e.g., due to invalid class name or non-existent default
     * constructor), the validator stays null and warning messages are logged.
     *
        ...
        if (this.initialStateValidator != null) {
            try {
                ...
                callback.processResponse(create
                        ...
                        .setResponseMessage("Invalid initial state provided. Error: " +
                                e.getMessage()));
                return null;
            }
        }
