...
public class ChainReplicaCoordinator<NodeIDType> extends AbstractReplicaCoordinator<NodeIDType> {

  private final ChainManager<NodeIDType> chainManager;

  public ChainReplicaCoordinator(
      Replicable app,
      NodeIDType myID,
    ...
    this.chainManager = new ChainManager<>(myID, unstringer, niot, this, null, true);
  }
  ...
  public Set<IntegerPacketType> getRequestTypes() {
    ...
    for (IntegerPacketType type : ChainPacket.ChainPacketType.values()) types.add(type);
  ...
  public boolean createReplicaGroup(
    ...
    return this.chainManager.createReplicatedChainForcibly(serviceName, epoch, nodes, this, state);
  }
