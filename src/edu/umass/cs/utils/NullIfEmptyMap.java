...
public class NullIfEmptyMap<KeyType, ValueType> {
  ...
  private TreeMap<KeyType, ValueType> map = null;
  ...
  public synchronized void put(KeyType key, ValueType value) {
    if (map == null) map = new TreeMap<KeyType, ValueType>();
    map.put(key, value);
  }
   ...
   */
  public synchronized TreeMap<KeyType, ValueType> getMap() {
    if (map == null) return new TreeMap<KeyType, ValueType>();
    TreeMap<KeyType, ValueType> copy = new TreeMap<KeyType, ValueType>(map);
    return copy;
  }
