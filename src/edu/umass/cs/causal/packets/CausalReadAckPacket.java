...
public class CausalReadAckPacket extends CausalPacket implements Byteable {
  ...
  public static CausalReadAckPacket createFromBytes(
    ...
    try {
      ...
      Logger.getGlobal()
          .log(Level.SEVERE, "Receiving an invalid encoded CausalReadAckPacket: " + e.getMessage());
      return null;
    }

    if (serviceName == null || senderId == null || encodedRequest == null) {
      Logger.getGlobal()
          .log(Level.SEVERE, "Receiving an invalid encoded CausalReadAckPacket: missing fields");
      return null;
    }
