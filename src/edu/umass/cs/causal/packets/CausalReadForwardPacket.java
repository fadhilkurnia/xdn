...
public class CausalReadForwardPacket extends CausalPacket implements Byteable {
    ...
    public CausalReadForwardPacket(String serviceName,
                                   String senderNodeId,
    ...
    private CausalReadForwardPacket(long packetId,
                                    String serviceName,
                                    String senderNodeId,
                                    ClientRequest clientReadRequest) {
    ...
    public static CausalReadForwardPacket createFromBytes(byte[] encodedPacket,
        ...
        if (packetType != CausalPacketType.CAUSAL_READ_FORWARD_PACKET.getInt()) {
            Logger.getGlobal().log(Level.SEVERE,
                    "Receiving an invalid encoded CausalReadForwardPacket: unexpected type " + packetType);
            return null;
        }
        ...
        if (serviceName == null || senderId == null || encodedRequest == null) {
            Logger.getGlobal().log(Level.SEVERE,
                    "Receiving an invalid encoded CausalReadForwardPacket: missing fields");
            return null;
        }
