...
public class CausalWriteForwardPacket extends CausalPacket implements Byteable {
  ...
  public CausalWriteForwardPacket(
      String serviceName,
      String senderId,
  ...
  public byte[] toBytes() {
    ...
    CausalPacketProto.CausalWriteForwardPacket.Builder protoBuilder =
        CausalPacketProto.CausalWriteForwardPacket.newBuilder()
            ...
            .setEncodedWriteRequest(ByteString.copyFrom(this.clientWriteOnlyRequest.toBytes()));
  ...
  @Override
  public int hashCode() {
    return Objects.hash(packetId, serviceName, senderId, requestTimestamp, clientWriteOnlyRequest);
  }
  ...
  public static CausalWriteForwardPacket createFromBytes(
      byte[] encodedPacket, AppRequestParser clientRequestParser) {
    ...
    for (CausalPacketProto.VectorTimestamp ts : decodedProto.getDependenciesList()) {
      ...
      for (CausalPacketProto.VectorTimestamp.NodeCounterPair pair : ts.getComponentsList()) {
    ...
    try {
      Request request =
          clientRequestParser.getRequest(decodedProto.getEncodedWriteRequest().toByteArray(), null);
