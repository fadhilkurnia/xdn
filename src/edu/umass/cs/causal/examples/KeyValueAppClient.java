...
public class KeyValueAppClient extends ReconfigurableAppClientAsync<edu.umass.cs.causal.examples.KeyValueAppRequest> {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            // send GET request
            edu.umass.cs.causal.examples.KeyValueAppRequest appRequest = new edu.umass.cs.causal.examples.KeyValueAppRequest(serviceName, myClientID, requestID, keys.get(i), null);
