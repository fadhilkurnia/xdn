...
public class KeyValueAppRequest implements ReplicableRequest, ClientRequest, BehavioralRequest {
  ...
  public KeyValueAppRequest(
      String serviceName, long clientID, long requestID, String key, String value, long version) {
  ...
  public KeyValueAppRequest(
      String serviceName, long clientID, long requestID, String key, String value) {
    this(serviceName, clientID, requestID, key, value, LATEST_VERSION);
  }

  public KeyValueAppRequest(
      String serviceName, long clientID, String key, String value, long version) {
    this(serviceName, clientID, /* requestID= */ System.currentTimeMillis(), key, value, version);
  }
  ...
  public String toString() {
    try {
      ...
      json.put("write_only", (this instanceof BehavioralRequest br && br.isWriteOnlyRequest()));
