...
public class QuorumCoordinator<NodeIDType>
    ...
    public Set<IntegerPacketType> getRequestTypes() {
        ...
        for (IntegerPacketType type: QuorumRequestPacket.QuorumPacketType.values())
            types.add(type);
