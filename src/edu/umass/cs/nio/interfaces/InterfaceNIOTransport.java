...
public interface InterfaceNIOTransport<NodeIDType, MessageType>
    extends AddressMessenger<MessageType> {
  /**
   * @param id The destination node ID.
   * @param msg The message to be sent.
   * @return Number of characters written. The number of characters is calculated by converting
   *     MessageType to a String. If MessageType is a byte[], then ISO-8859-1 encoding is used.
   * @throws IOException
   */
