...
/**
 * @author V. Arun
 * @param <NodeIDType> An interface to translate from IDs to socket addresses.
 */
public interface NodeConfig<NodeIDType> extends Stringifiable<NodeIDType> {
  ...
  /**
   * @return Set of all node IDs. Avoid using this method or at least avoid reusing the result of
   *     this method if the underlying set of nodes can change.
   */
