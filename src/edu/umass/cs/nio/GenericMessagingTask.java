...
public class GenericMessagingTask<NodeIDType, MessageType> {
  ...
  public GenericMessagingTask(Object[] destIDs, MessageType pkt) {
    assert (pkt != null && destIDs != null)
        : "Incorrect usage: InterfaceMessagingTask should not be instantiated with null messages or"
              + " destinations";
   ...
   * This is the only constructor that allows InterfaceMessagingTask to be instantiated with no
   * messages. We need this as it is convenient to create an empty InterfaceMessagingTask sometimes.
   *
   * @param destIDs
   * @param pkts
   */
  public GenericMessagingTask(Object[] destIDs, Object[] pkts) {
    ...
    for (Object obj : pkts)
      assert (obj != null)
          : "Incorrect usage: InterfaceMessagingTask should not be instantiated with null messages";
   ...
   * @param mtask1
   * @param mtask2
   * @return Returns an array of size two containing {@code mtask1} and {@code mtask2}.
   */
  ...
  static class Main {
    public static void main(String[] args) {
      GenericMessagingTask<Integer, String> mtask =
          new GenericMessagingTask<Integer, String>(23, "Hello");
      assert (mtask.msgs.length == 1 && mtask.msgs[0].equals("Hello"));
      Integer[] nodes = {23, 45, 66};
      GenericMessagingTask<Integer, String> mtask1 =
          new GenericMessagingTask<Integer, String>(nodes, "World");
