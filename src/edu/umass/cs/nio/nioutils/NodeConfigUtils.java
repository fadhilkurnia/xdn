...
public class NodeConfigUtils {
  public static NodeConfig<String> getNodeConfig(Map<String, InetSocketAddress> map) {
  ...
  public static NodeConfig<String> getNodeConfigFromFile(
      String filename, String nodePrefix, int offset) throws IOException {
    ...
    for (Object prop : props.keySet()) {
      ...
      if (key.startsWith(nodePrefix))
        map.put(
            key.replace(nodePrefix, ""),
            Util.getOffsettedAddress(
                Util.getInetSocketAddressFromString(props.getProperty(key).trim()), offset));
    }
    return getNodeConfig(map);
  }

  public static NodeConfig<String> getNodeConfigFromFile(String filename, String nodePrefix)
      throws IOException {
  ...
  public static void main(String[] args) throws IOException {
    ...
    writer.close();
    NodeConfig<?> nc = NodeConfigUtils.getNodeConfigFromFile(filename, "server.");
