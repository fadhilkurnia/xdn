...
/**
 * @author V. Arun
 *     <p>DefaultDataProcessingWorker simply prints the received data to standard output.
 */
public class DataProcessingWorkerDefault implements DataProcessingWorker {
