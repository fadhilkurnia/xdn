...
public class PramReadPacket extends PramPacket implements Byteable {
  ...
  public static PramReadPacket createFromBytes(
    ...
    try {
      ...
      Logger.getGlobal()
          .log(Level.SEVERE, "Receiving an invalid encoded PramReadPacket: " + e.getMessage());
      return null;
    }

    if (encodedRequest == null) {
      Logger.getGlobal()
          .log(Level.SEVERE, "Receiving an invalid encoded PramReadPacket: missing request");
      return null;
    }
