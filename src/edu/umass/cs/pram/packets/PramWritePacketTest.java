...
public class PramWritePacketTest {
    ...
    private static class DummyWriteOnlyAppRequest extends WriteOnlyRequest implements ClientRequest {
        ...
        public String toString() {
            return String.format("DummyWriteOnlyAppRequest{id:%d,svc:%s}",
    ...
    public void testSerializationDeserialization() {
        ...
        PramPacket decoded = PramPacket.createFromBytes(
                sourcePacket.toBytes(), new DummyWriteOnlyAppRequestParser());
        ...
        assertEquals(sourcePacket.getClientWriteRequest().getRequestType(),
