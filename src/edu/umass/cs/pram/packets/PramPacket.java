...
public abstract class PramPacket implements ReplicableRequest {
  ...
  public static PramPacket createFromBytes(
      byte[] encodedPacket, AppRequestParser appRequestParser) {
    PramPacketType packetType = PramPacket.getQuickPacketTypeFromEncodedPacket(encodedPacket);
    ...
    return switch (packetType) {
      ...
      case PRAM_WRITE_AFTER_PACKET -> PramWriteAfterPacket.createFromBytes(
