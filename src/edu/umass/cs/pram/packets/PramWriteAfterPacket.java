...
public class PramWriteAfterPacket extends PramPacket {
    ...
    /**
     * Initialize a PramWriteAfterPacket given JSONObject and AppRequestParser, which is needed
     * because PramWriteAfterPacket also needs to deserialize AppRequest (i.e., ClientRequest) that
     * is wrapped by PramWriteAfterPacket.
     *
     * @param jsonObject a valid serialized JSONObject from a PramWriteAfterPacket, generated by
     *                   {@link PramWriteAfterPacket#toJSONObjectImpl()}.
     * @param appRequestParser deserializer to parse ClientRequest embedded inside
     *                         the {@param jsonObject}.
     * @return PramWriteAfterPacket if deserialization process is success, otherwise null.
     */
    public static PramWriteAfterPacket fromJsonObject(JSONObject jsonObject,
