...
public class InitBackupPacket extends PrimaryBackupPacket implements Byteable {
  ...
  @Deprecated public static final String SERIALIZED_PREFIX = "pb:init:";

  private final long packetId;
  private final String serviceName;

  public InitBackupPacket(String serviceName) {
    this(Math.abs(UUID.randomUUID().getLeastSignificantBits()), serviceName);
  }
  ...
  public boolean equals(Object o) {
    ...
    return this.packetId == that.packetId && Objects.equals(serviceName, that.serviceName);
  }
  ...
  public static InitBackupPacket createFromBytes(byte[] encodedPacket) {
    ...
    return new InitBackupPacket(decodedProto.getPacketId(), decodedProto.getServiceName());
  }
