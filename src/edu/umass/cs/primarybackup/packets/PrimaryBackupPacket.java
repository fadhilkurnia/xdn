...
public abstract class PrimaryBackupPacket implements ReplicableRequest {
  ...
  public static PrimaryBackupPacketType getQuickPacketTypeFromEncodedPacket(byte[] encodedPacket) {
  ...
  public static PrimaryBackupPacketType getQuickPacketTypeFromEncodedPacket(String encodedPacket) {
  ...
  public static PrimaryBackupPacket createFromString(String encodedPacket) {
    return PrimaryBackupPacket.createFromBytes(encodedPacket.getBytes(StandardCharsets.ISO_8859_1));
  }
}
