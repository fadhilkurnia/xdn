...
/**
 * Pairs a request with its callback, plus mutable pipeline timestamps for latency instrumentation.
 */
public final class RequestAndCallback {
  ...
  public ExecutedCallback callback() {
    return callback;
  }

  public long pbmEntryNs() {
    return pbmEntryNs;
  }

  public long workerPickupNs() {
    return workerPickupNs;
  }

  public long executeEndNs() {
    return executeEndNs;
  }

  public long doneQueueNs() {
    return doneQueueNs;
  }

  public long captureDrainNs() {
    return captureDrainNs;
  }

  public long captureDiffEndNs() {
    return captureDiffEndNs;
  }

  public long proposeNs() {
    return proposeNs;
  }

  public long commitCallbackNs() {
    return commitCallbackNs;
  }

  public void setPbmEntryNs(long ns) {
    this.pbmEntryNs = ns;
  }

  public void setWorkerPickupNs(long ns) {
    this.workerPickupNs = ns;
  }

  public void setExecuteEndNs(long ns) {
    this.executeEndNs = ns;
  }

  public void setDoneQueueNs(long ns) {
    this.doneQueueNs = ns;
  }

  public void setCaptureDrainNs(long ns) {
    this.captureDrainNs = ns;
  }

  public void setCaptureDiffEndNs(long ns) {
    this.captureDiffEndNs = ns;
  }

  public void setProposeNs(long ns) {
    this.proposeNs = ns;
  }

  public void setCommitCallbackNs(long ns) {
    this.commitCallbackNs = ns;
  }
  ...
  public String formatPipelineTimingMs() {
    ...
    return String.format(
        "queueWait=%.2f exec=%.2f captureWait=%.2f capture=%.2f propose=%.2f paxosCommit=%.2f"
            + " total=%.2f batchSize=%d",
