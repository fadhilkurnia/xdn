...
/**
 * MonotonicApp is a simple application, with no sharding i.e, only single object/service name, that
 * records a sequence of monotonically increasing numbers. For example, the app records these
 * numbers below: [1, 3, 10, 99, 1001, 3011]
 *
 * <p>The app can receive two kind of requests: GenerateNumber and GetSequence, which respectively,
