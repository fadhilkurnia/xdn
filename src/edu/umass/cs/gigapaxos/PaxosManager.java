...
public class PaxosManager<NodeIDType> {
    ...
    /**
     * @param id                    My node ID.
     * @param unstringer            An instance of Stringifiable that can convert String to
     *                              NodeIDType.
     * @param niot                  InterfaceNIOTransport or InterfaceMessenger object used for
     *                              messaging.
     ...
     *
     * @param paxosID The name of the object or service being managed as a
    ...
    /**
     * In order to implement randomization in running for coordinator, we need
     * to schedule a future event with a random delay, which is done by creating
     * a no-op "poke" message as everything in the PISM design is event-driven
    ...
    /**
     * A utility method to check the Replicable Application being handled by this Paxos Manager.
     * Note that the handled Application can be wrapped by classes generated by
     * LargeCheckpointer.wrap(.) and TrivialRepliconfigurable(.).
     *
    ...
    public boolean isAppEquals(Replicable another) {
        ...
        while ((myWrappedApp instanceof LargeCheckpointer.LargeCheckpointerWrappedApp ||
            ...
            if (myWrappedApp instanceof TrivialRepliconfigurable trivialApp) {
                myWrappedApp = trivialApp.app instanceof Replicable
                        ? (Replicable) trivialApp.app : null;
