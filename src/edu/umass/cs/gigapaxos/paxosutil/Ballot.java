...
/**
 * @author V. Arun
 *     <p>A ballot is simply a <ballotNumber, ballotCoordinator> two-tuple of integers. Ballots are
 *     completely ordered. In paxos, every decision, i.e., a committed request, is committed with
 *     some slot number and a ballot. A proposal, i.e., <slot, request> two-tuple can possibly get
 *     committed as a decision in multiple ballots, but paxos ensures the safety property that two
 *     different requests never get committed with the same slot irrespective of the ballot.
 */
