...
/**
 * @author V. Arun
 *     <p>Utility class extending MessagingTask by adding a to-log message.
 */
@SuppressWarnings("javadoc")
public class LogMessagingTask extends MessagingTask {
  /**
   * The logMessage that needs to be persistently logged and then transmitted upon successful
   * logging.
   */
