...
/**
 * @author V. Arun
 *     <p>A utility class to do some action repeatedly but in a rate limited manner.
 */
public class RateLimiter {
  ...
  public void record() {
    ...
    if (count++ == 0) this.beginTime = curTime;
  ...
  static class Main {
    public static void main(String[] args) {
      ...
      System.out.println(
          "Finished " + size + " ops in " + (System.currentTimeMillis() - t1) / 1000.0 + " secs.");
    }
  }
}
