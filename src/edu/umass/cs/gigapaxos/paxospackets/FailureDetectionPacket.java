...
/**
 * @author arun
 * @param <NodeIDType> This "failure detection" packet is really a keep-alive, i.e., its purpose is
 *     to tell the recipient that the sender is up.
 */
...
public class FailureDetectionPacket<NodeIDType> extends PaxosPacket {
  ...
  public FailureDetectionPacket(
      NodeIDType senderNodeID, NodeIDType responderNodeID, boolean status) {
  ...
  public FailureDetectionPacket(JSONObject json, Stringifiable<NodeIDType> unstringer)
