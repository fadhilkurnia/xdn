...
public final class PreparePacket extends PaxosPacket {
  ...
  /** First undecided slot at coordinator. Only used as an optimization, not for safety. */
  ...
  public PreparePacket(JSONObject json) throws JSONException {
    ...
    this.firstUndecidedSlot = json.getInt(PaxosPacket.Keys.PREP_MIN.toString());
  ...
  public JSONObject toJSONObjectImpl() throws JSONException {
    ...
    json.put(PaxosPacket.Keys.PREP_MIN.toString(), firstUndecidedSlot);
