...
public final class AcceptPacket extends PValuePacket {
  ...
  public AcceptPacket(ByteBuffer bbuf) throws UnsupportedEncodingException, UnknownHostException {
    super(bbuf);
  ...
  public synchronized byte[] toBytes() {
    ...
    if (!(PaxosPacket.BYTEIFICATION && IntegerMap.allInt())) return super.toBytes();

    if (this.getByteifiedSelf() != null) return this.getByteifiedSelf();
    ...
    bbuf.putInt(this.slot)
        ...
        .putInt(this.getMedianCheckpointedSlot())
        .put((byte) 0)
        // accept
        .putInt(this.sender);
  ...
  public AcceptPacket(byte[] bytes) throws UnsupportedEncodingException, UnknownHostException {
  ...
  public AcceptPacket undigest(RequestPacket req) {
    ...
    return (AcceptPacket)
        new AcceptPacket(
            this.sender,
            new PValuePacket(this.ballot, new ProposalPacket(this.slot, req)),
            this.getMedianCheckpointedSlot());
  }
