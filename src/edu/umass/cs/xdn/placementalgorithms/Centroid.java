 ...
 *   <li>Select the {@code targetReplicas} closest nodes; the closest becomes the preferred
 *       coordinator.
 * </ol>
 *
 * <p>The {@code readType}, {@code writeType}, and {@code Q} parameters are accepted for interface
 * compatibility but are not used — the centroid model does not distinguish access types.
 */
