...
/**
 * XDNTestFuseClient is a test script to validate that our FUSE based approach works, and accessible
 * via Java.
 */
public class XdnTestFuseClient {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      System.out.println(
          ">> got " + numRead + " " + new String(sizeBuffer.array(), StandardCharsets.UTF_8));
      if (numRead < 8) {
