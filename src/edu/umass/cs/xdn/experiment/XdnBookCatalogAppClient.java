...
public class XdnBookCatalogAppClient extends ReconfigurableAppClientAsync<String> {
    ...
    public Request getRequest(String stringified) throws RequestParseException {
        XdnRequestType requestType =
                XdnHttpRequest.getQuickPacketTypeFromEncodedPacket(stringified);
    ...
    public static void main(String[] args) throws IOException {
        ...
        Set<InetSocketAddress> controlPlaneServers =
                Set.of(new InetSocketAddress("127.0.0.1", 3000));
        ...
        String content = "{\"title\": \"Distributed Systems of " + randomId +
                "\", \"author\": \"Tanenbaum\"}";
        ...
        client.sendRequest(xdnHttpRequest, response -> {
