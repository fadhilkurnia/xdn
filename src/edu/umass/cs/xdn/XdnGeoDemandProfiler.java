...
public class XdnGeoDemandProfiler extends AbstractDemandProfile {
    ...
    private static final Logger LOGGER =
            Logger.getLogger(XdnGeoDemandProfiler.class.getName());
    ...
    public JSONObject getDemandStats() {
        ...
        LOGGER.log(Level.INFO,
                "XdnGeoDemandProfiler [AR] Sending demand report for {0}: reads={1} cells, writes={2} cells, totalReqs={3}",
                new Object[]{
    ...
    private boolean enqueueIfGeo(XdnHttpRequest req) {
        ...
        if (!eventQueue.offer(new GeolocatedRequest(geo, isWrite))) {
            LOGGER.log(Level.FINE,
                    "XdnGeoDemandProfiler event queue full, dropping sample for {0}", this.name);
            return false;
        }
        return true;
    }
