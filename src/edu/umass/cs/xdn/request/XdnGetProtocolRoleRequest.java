...
public class XdnGetProtocolRoleRequest extends XdnRequest implements ClientRequest {
    ...
    public XdnGetProtocolRoleRequest(String serviceName) {
    ...
    public String getJsonResponse() {
        try {
            ...
            json.put("role", this.roleName != null ? this.roleName : "?");
