...
/**
 * @author arun
 *     <p>This request aborts a transaction. At a transaction group member, the corresponding
 *     callback will trigger aborts to participant groups, and will also undo any constituent create
 *     name operations. At a participant group member, the callback will revert to the
...
public class AbortRequest extends TXPacket {
  ...
  public AbortRequest(String initiator, String participantGroup, String txGroupName) {
