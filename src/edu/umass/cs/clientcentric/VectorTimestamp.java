...
public class VectorTimestamp {
  ...
  public static VectorTimestamp createFromString(String encodedTimestamp) {
    ...
    assert encodedTimestamp.startsWith(validPrefix) : "Incorrect string format for VectorTimestamp";

    String rawTimestamp =
        encodedTimestamp.substring(validPrefix.length(), encodedTimestamp.length() - 1);
