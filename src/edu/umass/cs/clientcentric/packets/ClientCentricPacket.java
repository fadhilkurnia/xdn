...
public abstract class ClientCentricPacket implements ReplicableRequest {
  ...
  public static ClientCentricPacket createFromBytes(
    ...
    return switch (packetType) {
      case CLIENT_CENTRIC_WRITE_AFTER_PACKET -> ClientCentricWriteAfterPacket.createFromBytes(
          encodedPacket, appRequestParser);
      case CLIENT_CENTRIC_SYNC_REQ_PACKET -> ClientCentricSyncRequestPacket.createFromBytes(
          encodedPacket);
      case CLIENT_CENTRIC_SYNC_RES_PACKET -> ClientCentricSyncResponsePacket.createFromBytes(
          encodedPacket);
