...
public class ClientCentricSyncResponsePacket extends ClientCentricPacket implements Byteable {
  ...
  public ClientCentricSyncResponsePacket(
      String senderId, String serviceName, long fromSequenceNumber, List<byte[]> encodedRequests) {
  ...
  private ClientCentricSyncResponsePacket(
    ...
    this.encodedRequests =
        encodedRequests == null
  ...
  public static ClientCentricSyncResponsePacket createFromBytes(byte[] encodedPacket) {
    ...
    return new ClientCentricSyncResponsePacket(
        packetId, senderId, serviceName, fromSequenceNumber, requests);
  }
}
