...
public class ClientCentricSyncRequestPacket extends ClientCentricPacket implements Byteable {
  ...
  public ClientCentricSyncRequestPacket(
      String senderId, String serviceName, long fromSequenceNumber) {
    this(System.currentTimeMillis(), senderId, serviceName, fromSequenceNumber);
  }

  private ClientCentricSyncRequestPacket(
      long packetId, String senderId, String serviceName, long fromSequenceNumber) {
  ...
  public static ClientCentricSyncRequestPacket createFromBytes(byte[] encodedPacket) {
    ...
    return new ClientCentricSyncRequestPacket(packetId, senderId, serviceName, fromSequenceNumber);
  }
}
