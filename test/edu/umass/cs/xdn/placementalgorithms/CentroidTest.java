...
public class CentroidTest {
  ...
  void testSingleCellSingleNode_thatNodeSelected() {
    ...
    PlacementResult result =
        centroid.selectReplicas(reads, writes, nodes, 1, "Closest", "Closest", 1);
  ...
  void testSingleCellMultipleNodes_closestNodeSelected() {
    ...
    PlacementResult result =
        centroid.selectReplicas(reads, Collections.emptyMap(), nodes, 1, "Closest", "Closest", 1);
  ...
  void testTargetReplicasExceedsNodes_allNodesReturned() {
    ...
    PlacementResult result =
        centroid.selectReplicas(reads, Collections.emptyMap(), nodes, 5, "Closest", "Closest", 1);
  ...
  void testCoordinatorAlwaysInReplicaSet() {
    ...
    PlacementResult result =
        centroid.selectReplicas(reads, Collections.emptyMap(), nodes, 2, "Closest", "Closest", 1);
  ...
  void testReadTypeAndWriteTypeIgnored_sameResultRegardless() {
    ...
    PlacementResult r1 =
        centroid.selectReplicas(reads, Collections.emptyMap(), nodes, 1, "Majority", "Source", 3);
    PlacementResult r2 =
        centroid.selectReplicas(reads, Collections.emptyMap(), nodes, 1, "Closest", "Closest", 1);
