...
public class XdnSetCoordinatorNodeTest {
    ...
    private HttpResponse<String> sendSetCoordinatorRequest(XdnTestCluster cluster,
                                                           String serviceName,
                                                           String newCoordinator) throws Exception {
        String endpoint = "http://127.0.0.1:" + cluster.getReconfiguratorHttpPort()
                + "/api/v2/services/" + serviceName + "/coordinator";
    ...
    private Map<String, String> awaitReplicaRoles(XdnTestCluster cluster,
                                                  String serviceName,
    ...
    private Map<String, String> fetchReplicaRoles(XdnTestCluster cluster,
        ...
        for (int replicaIdx = 0; replicaIdx < REPLICA_COUNT; replicaIdx++) {
            HttpResponse<String> infoResponse = cluster.sendGetRequest(
                    serviceName, replicaIdx, endpoint, XdnTestCluster.REQUEST_TIMEOUT);
