...
public class PrimaryIntegrityTest {
    ...
    public void PrimaryIntegrityTest_SendRequestsToPrimaryNode()
        ...
        Set<String> nodes = Set.of(PrimaryIntegrityTestHelper.NODE_1_ID,
    ...
    @Test
    public void PrimaryIntegrityTest_SendRequestsToAllNodes() throws
    ...
    @Test
    public void PrimaryIntegrityTest_SendPrimaryChanges() throws
            ...
            node2.coordinateRequest(
                    ...
                    (executedRequest, handled) -> {
                        ...
                        System.out.printf("\n\nRequest-%d to %s is executed. response: %s \n\n",
                                finalI, PrimaryIntegrityTestHelper.NODE_2_ID,
        ...
        ChangePrimaryPacket changePrimaryPacket = new ChangePrimaryPacket(
                serviceName, PrimaryIntegrityTestHelper.NODE_3_ID);
    ...
    @Test
    public void PrimaryIntegrityTest_PrimaryChangesWithRequest() throws
            InterruptedException, RequestParseException, IOException {
        ...
        ChangePrimaryPacket changePrimaryPacket = new ChangePrimaryPacket(
                serviceName, PrimaryIntegrityTestHelper.NODE_1_ID);
            ...
            node1.coordinateRequest(
                    ...
                    (executedRequest, isRequestHandled) -> {
                        ...
                        System.out.printf("""
                                        ...
                                        """,
                                finalJ, PrimaryIntegrityTestHelper.NODE_1_ID,
                                response.getResponseValue());
                    }
            );
            Thread.sleep(50);
    ...
    @Test
    public void PrimaryIntegrityTest_SendRequestWhilePrimaryChanges() throws
            InterruptedException, RequestParseException, IOException {
                            ...
                            node3.coordinateRequest(
                                    ...
                                    (executedRequest, isRequestHandled) -> {
                                        ...
                                        System.out.printf("""
                                                        ...
                                                        """,
                                                finalJ, PrimaryIntegrityTestHelper.NODE_3_ID,
                                                response.getResponseValue());
                                    }
                            );
                            Thread.sleep(20);
