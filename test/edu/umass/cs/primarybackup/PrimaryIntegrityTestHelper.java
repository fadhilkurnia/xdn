...
public class PrimaryIntegrityTestHelper {
    ...
    protected static Map<String, CoordinatorNode> startThreeNodesWithMonotonicApp(
        ...
        ReconfigurationPacketDemultiplexer pdAtNode1 = PrimaryIntegrityTestHelper.
                createDefaultPacketDemultiplexer(
                        node1ID, config);
        JSONMessenger<String> messengerAtNode1 = PrimaryIntegrityTestHelper.createNodeDefaultMessenger(
        ...
        servers.put(node1ID, new PrimaryIntegrityTestHelper.CoordinatorNode(
                node1,
        ...
        ReconfigurationPacketDemultiplexer pdAtNode2 = PrimaryIntegrityTestHelper.
                createDefaultPacketDemultiplexer(node2ID, config);
        JSONMessenger<String> messengerAtNode2 = PrimaryIntegrityTestHelper.createNodeDefaultMessenger(
        ...
        servers.put(node2ID, new PrimaryIntegrityTestHelper.CoordinatorNode(
                node2,
        ...
        ReconfigurationPacketDemultiplexer pdAtNode3 = PrimaryIntegrityTestHelper.
                createDefaultPacketDemultiplexer(
                        node3ID, config);
        JSONMessenger<String> messengerAtNode3 = PrimaryIntegrityTestHelper.createNodeDefaultMessenger(
        ...
        servers.put(node3ID, new PrimaryIntegrityTestHelper.CoordinatorNode(
                node3,
